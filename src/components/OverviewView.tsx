...
export function OverviewView({ state, dispatch }: OverviewViewProps) {
  ...
  return (
    <div
      className={`main-view-panel location-view-panel overview-view ${portraitLockPageClass(portraitLarge)}`}
    >
      {portraitLarge ? (
        <LocationViewHeader
          title="Overview"
        ...
        >
          {portraitLarge ? (
            ...
            <div className="portrait-lock-split-right">
              ...
              <div className="portrait-lock-scroll-body">{overviewBody}</div>
            </div>
          )}
        </TabPortraitLayout>
      </div>
